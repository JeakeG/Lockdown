...
function HUD()
    ...
    local playerBalance = client:GetBalance()    

    if (lastNum != playerBalance) then
        print(playerBalance)
        lastNum = playerBalance
    end
    ...
    draw.SimpleText("$ " .. playerBalance, "DermaDefaultBold", 260, ScrH() - 95, Color(255, 255, 255, 255), 0, 0)
